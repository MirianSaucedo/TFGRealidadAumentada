		...
		if(distanciaJesus < 1000){
			...
			$.ajax({
				...
				success: function(datos){
		        	...
		        	createPOIGeneric(++j, "Santisima Trinidad", trinidad, trinidad_esp, "http://168.90.176.30/infotour/img/39.jpg");
		    	},
				error: function (obj, error, objError){
		   			alert("Error: Verifica tu conexión a internet.");
				}
			});	
			...
			$.ajax({
				...
				success: function(datos){
		        	...
		        	createPOIGeneric(++j, "Jesus de Tavarangue", jesus, jesus_esp, "http://168.90.176.30/infotour/img/11.jpg");
		    	},
				error: function (obj, error, objError){
		   			alert("Error: Verifica tu conexión a internet.");
				}
			...
			createPOIGeneric(1, "Jesus de Tavarangue", jesus, jesus_esp, "http://168.90.176.30/infotour/img/11.jpg");
			createPOIGeneric(2, "Santisima Trinidad", trinidad, trinidad_esp, "http://168.90.176.30/infotour/img/39.jpg");
		}
	});
});

		...
		if(distanciaJesus < 1000){
			...
			$.ajax({
				...
				success: function(datos){
		        	...
		        	createPOIGeneric(++j, "Santisima Trinidad", trinidad, trinidad_por, "http://168.90.176.30/infotour/img/39.jpg");
		    	},
				error: function (obj, error, objError){
		   			alert("Error: Verifique o seu coneção de internet");
				}
			});	
			...
			$.ajax({
				...
				success: function(datos){
		        	...
		        	createPOIGeneric(++j, "Jesus de Tavarangue", jesus, jesus_por, "http://168.90.176.30/infotour/img/11.jpg");
				},
				error: function (obj, error, objError){
		   			alert("Error: Verifique o seu coneção de internet");
				}
			...
			createPOIGeneric(1, "Jesus de Tavarangue", jesus, jesus_por, "http://168.90.176.30/infotour/img/11.jpg");
			createPOIGeneric(2, "Santisima Trinidad", trinidad, trinidad_por, "http://168.90.176.30/infotour/img/39.jpg");
		}
	});
});
